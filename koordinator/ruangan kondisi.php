		...
		<div class="halaman">
			<header class="header">
				<div class="isi-header">	
					<div class="logo">
						<font size="5" color="#0C3"><b>UNS</b></font><font size="5" color="#EAEA00"><b>I</b></font><font size="5" color="#0C3"><b>KA</b></font>
					</div>
					<div class="menu-atas">
						<ul>
    ...
    ?>
			...
			<footer class="footer">
				<div class="isi-footer">
					<p>&copy; Copyright <a href="#">Informasi Ruangan</a> &#124; <a href="#">4D</a> &#124; <a href="#">Teknik Informatika 2018</a></p>
					<div class="hapus"></div>
				</div>
			</footer>
		</div>
